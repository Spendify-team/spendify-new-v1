                ...
                <article className="mt-70 mt-lg-0 justify-content-center">
                  <div className="privacy-item" id="general">
                    ...
                    <p style={pStyle}>
                      ...
                      provided by your mobile network provider, but Spendify Technologies cannot take
                    ...
                    <p style={pStyle}>
                      ...
                      Along the same lines, Spendify Technologies cannot always take responsibility
                    ...
                    <p style={pStyle}>
                      ...
                      you. Spendify Technologies accepts no liability for any loss, direct or
                    ...
                    <p style={pStyle}>
                      ...
                      download the updates if you want to keep using the app. Spendify Technologies
                      does not promise that it will always update the app so that it is relevant to
                      you and/or works with the Android version that you have installed on your
                      ...
                      tell you otherwise, upon any termination, (a) the rights and licenses granted to
                      you in these terms will end; (b) you must stop using the app, and (if needed)
